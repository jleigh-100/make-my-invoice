...
const FileImporter = ({ setClients }) => {
  ...
  const onDrop = (acceptedFiles) => {
    ...
    reader.onload = () => {
      ...
      const headerLine = lines.splice(0, 1)[0]; // remove header row
      if (headerLine !== "Project,Client,Description,Duration") return alert("Please upload a CSV file exported from Toggl");
